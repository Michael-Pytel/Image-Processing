...
class PhotoEditor(QMainWindow):
    ...
    def setup_image_display(self):
        ...
        self.zoom_out_btn.setIcon(self.style().standardIcon(self.style().SP_MediaVolumeMuted))
        ...
        self.zoom_in_btn.setIcon(self.style().standardIcon(self.style().SP_MediaVolume))
    ...
    def create_menu_bar(self):
        ...
        # Undo action
        undo_action = QAction(self.style().standardIcon(self.style().SP_ArrowBack), "Undo Last Change", self)
    ...
    def update_image_display(self):
        if self.current_image is not None:
            ...
            self.zoom_reset_btn.setText(f"{int(self.scale_factor * 100)}%")
